...
void main() {
  ...
  Future<void> startApp(WidgetTester tester) async {
    ...
    expect(
      ...
      findsOneWidget,
      reason: 'The app should start on the Dashboard screen.',
    );
  }
  ...
  Future<void> saveTask(WidgetTester tester) async {
    ...
    expect(
      find.byKey(const Key('dashboard_screen')),
      findsOneWidget,
      reason: 'Saving the task should return the user to the Dashboard.',
    );
  }
  ...
  Future<void> createTask(
    ...
    await enterTaskDetails(tester, title: title, description: description);
  ...
  testWidgets('User can navigate from Dashboard to Add Task screen', (
    tester,
  ) async {
    await startApp(tester);
  ...
  testWidgets('User can add a new task and see it on Dashboard', (
    tester,
  ) async {
    await startApp(tester);
  ...
  testWidgets('User can open Task Details screen', (tester) async {
    ...
    expect(
      find.text('This task is used to test the details screen'),
      findsOneWidget,
    );
  ...
  testWidgets('User can mark task as completed from Task Details', (
    tester,
  ) async {
    await startApp(tester);
    ...
    await tapVisible(
      tester,
      find.byKey(const Key('details_toggle_complete_button')),
    );
  ...
  testWidgets('Statistics screen shows zero counts when no tasks exist', (
    tester,
  ) async {
    await startApp(tester);
